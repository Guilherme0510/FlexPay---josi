        ...
        {empresa && (
          <div className="empresa-details-grid">
            <div className="empresa-details-column">
              ...
              <p><strong>Nome Empresa:</strong> {empresa.nomeEmpresa}</p>
              <p><strong>CNPJ:</strong> {empresa.cnpj}</p>
              <p><strong>Email:</strong> {empresa.email}</p>
              <p><strong>Telefone:</strong> {empresa.telefone}</p>
              <p><strong>Data de Abertura:</strong> {empresa.dataAbertura}</p>
              <p><strong>Regime AP:</strong> {empresa.regimeAP}</p>
              <p><strong>IE:</strong> {empresa.ie}</p>
              <p>
                <strong>Categoria da Empresa:</strong>{" "}
                <span className="text-capitalize">
                  {empresa.categoriaEmpresa.includes("naoHaMovimento")
                    ? "Não há movimento"
                    : empresa.categoriaEmpresa.includes("folhaPagamento")
                    ? "Folha de Pagamento"
            ...
            <div className="empresa-details-column">
              <p><strong>CCM:</strong> {empresa.ccm}</p>
              <p><strong>CNAE:</strong> {empresa.cnae}</p>
              <p><strong>Código SN:</strong> {empresa.codigoSN}</p>
              <p><strong>CPF:</strong> {empresa.cpf}</p>
              <p><strong>Logradouro:</strong> {empresa.logradouro}</p>
              <p><strong>Username Sefaz:</strong> {empresa.usernameSefaz}</p>
              <p><strong>Senha Sefaz:</strong> {empresa.senhaSefaz}</p>
              <p><strong>Senha Prefeitura:</strong> {empresa.senhaPrefeitura}</p>
            </div>
          </div>
        )}
      </Modal.Body>
